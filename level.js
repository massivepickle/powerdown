                ...
                if(start === 1){
                    ...
                    if(!won && !go){
                        if(opaque){
                            ...
                            text("DISAPPEAR IN: " + roundoff(appearin,1), camera.position.x, camera.position.y - windowHeight/(camera.zoom * 2) + 18*windowHeight/1080); 
                        }else{
                            textAlign(CENTER);
                            textStyle(BOLD);
                            textFont("OCR A");
                            ...
                            fill("purple");
                            stroke(255,255,255,200);
                            text("APPEAR IN: " + roundoff(appearin-10+endbreaks,1), camera.position.x, camera.position.y - windowHeight/(camera.zoom * 2) + 18*windowHeight/1080);
                        }
                    }
                    if(endbreaks >= 5){
                        won = true;
                    ...
                    if(rbt[0].dashin >= -0.5 && !go){
                        ...
                        if(rbt[0].dashin > 0.1){
                            fill("purple");
                            stroke(255,255,255,200);
                            text("\nDASH IN: " + roundoff(rbt[0].dashin,1), camera.position.x, camera.position.y - windowHeight/(camera.zoom * 2) + 18*windowHeight/1080);
                        }else{
                            fill("#B80F0A");
                            stroke(255,255,255,200);
                            text("\nDASH!", camera.position.x, camera.position.y - windowHeight/(camera.zoom * 2) + 18*windowHeight/1080);
                        }
                    }
